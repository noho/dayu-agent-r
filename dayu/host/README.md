...
- Host-owned LLM compactor baseline，包含 runner 配置、compact artifact root，以及 Service 从 `conversation_compaction` scene 装配的 compactor system prompt / user prompt template，供 Context Governance 执行 compact。
