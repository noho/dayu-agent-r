...
当前 ToolRuntime 仍不执行真实工具 callable；真实工具 dispatch、截断、`fetch_more` callable、重复工具事实治理算法、policy provider resolution、attempt tool snapshot durability 与长耗时 external job / wait record 均未实现。
