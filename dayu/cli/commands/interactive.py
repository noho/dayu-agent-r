    ...
    try:
        while True:
            ...
            if submit_task in done:
                ...
                _finish_interactive_runtime_display(
                    run_view=view,
        ...
        if view is not None:
            view.set_runtime_line_guard(None)
