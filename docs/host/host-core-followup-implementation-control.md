...
| gate | implementation |
| implementation status | WU-LAYER-02 plan accepted; Slice 1 pending |
...
| current slice | WU-LAYER-02 implementation Slice 1 pending |
...
| next entry point | WU-LAYER-02 implementation Slice 1 |
