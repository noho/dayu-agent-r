...
| gate | implementation |
| implementation status | WU-LAYER-01 draft-local-pass; WU-LAYER-02 pending |
...
| current slice | WU-LAYER-02 discussion / code inspection pending |
...
| next entry point | WU-LAYER-02 discussion / code inspection |
