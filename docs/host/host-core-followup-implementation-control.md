...
| gate | implementation |
| implementation status | WU-DUR-01 + WU-DUR-02 plan review / re-review passed；ready for Slice 1 implementation |
| active work unit | WU-DUR-01 + WU-DUR-02 |
| default next work unit | WU-DUR-01 + WU-DUR-02 |
| next entry point | WU-DUR-01 + WU-DUR-02 implementation gate：dispatch Slice 1 Bootstrap Atomicity And Current-schema Validation from approved plan |
