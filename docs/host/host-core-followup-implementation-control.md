...
| gate | implementation |
| implementation status | WU-STRESS-01 slice 4 accepted；implementation slice 5 ready |
| active work unit | WU-STRESS-01 |
| default next work unit | WU-STRESS-01 |
| next entry point | WU-STRESS-01 implementation gate：按 accepted plan 进入 Slice 5 mixed Host stress with deterministic fault injection |
...
| WU-STRESS-01 | Host production stress suite | crash / recovery / watch / scheduler 组合压力 | 进行中：slice 4 accepted；slice 5 ready |
