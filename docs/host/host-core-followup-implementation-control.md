...
| gate | implementation |
| implementation status | WU-DUR-01 + WU-DUR-02 Slice 2 code review / re-review passed；ready for Slice 3 implementation |
| active work unit | WU-DUR-01 + WU-DUR-02 |
| default next work unit | WU-DUR-01 + WU-DUR-02 |
| next entry point | WU-DUR-01 + WU-DUR-02 implementation gate：dispatch Slice 3 Durable Concurrency Matrix Gap Tests from approved plan |
