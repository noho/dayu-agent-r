...
| implementation status | WU-DUR-01 + WU-DUR-02 已完成：draft-PR-pass；WU-LIFE-01 + WU-LIFE-02 已完成：draft-PR-pass；WU-CTX-02 + WU-CTX-03 accepted aggregate deepreview commit: 029fa68，已准备进入 draft PR gate |
| active work unit | WU-CTX-02 + WU-CTX-03 |
| default next work unit | WU-CTX-02 + WU-CTX-03 |
| next entry point | WU-CTX-02 + WU-CTX-03 draft PR gate；WU-LIFE-01 + WU-LIFE-02 merge / ready-for-review / reviewer request require separate authorization；WU-DUR-01 + WU-DUR-02 merge / ready-for-review / reviewer request require separate authorization |
...
| WU-CTX-02 | Compact failure policy | compact failure 策略矩阵与 E2E | ready-to-open-draft-PR |
| WU-CTX-03 | Reactive overflow loop E2E | reactive overflow 循环收口测试 | ready-to-open-draft-PR |
