...
| gate | implementation |
| implementation status | WU-STRESS-01 slice 3 accepted；implementation slice 4 ready |
| active work unit | WU-STRESS-01 |
| default next work unit | WU-STRESS-01 |
| next entry point | WU-STRESS-01 implementation gate：按 accepted plan 进入 Slice 4 scheduler / liveness long-run stress |
...
| WU-STRESS-01 | Host production stress suite | crash / recovery / watch / scheduler 组合压力 | 进行中：slice 3 accepted；slice 4 ready |
