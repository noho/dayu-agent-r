...
| gate | implementation |
| implementation status | WU-STRESS-01 plan accepted；implementation slice 1 ready |
| active work unit | WU-STRESS-01 |
| default next work unit | WU-STRESS-01 |
| next entry point | WU-STRESS-01 implementation gate：按 accepted plan 从 Slice 1 stress marker / 默认排除 / summary helper 基础开始 |
