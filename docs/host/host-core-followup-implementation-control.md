...
| gate | implementation |
| implementation status | WU-LAYER-02 Slice 2 accepted; acceptance record pending |
...
| current slice | WU-LAYER-02 Slice 2 acceptance record |
...
| next entry point | WU-LAYER-02 Slice 3 implementation dispatch |
