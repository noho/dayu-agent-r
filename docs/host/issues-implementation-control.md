...
| gate | implementation |
| implementation status | WU-TOOLS-01-F02 PR #132 merged 2026-06-10; WU-TOOLS-01-F03 plan accepted, accepted plan commit 262a6021 |
...
| WU-TOOLS-01-F03 | implementation | Web CI smoke generation | GitHub Issue #120 under #98 follow-up; depends on WU-TOOLS-01-F02 | Plan accepted；plan artifact `docs/host/wu-tools-01-f03-web-ci-smoke-plan.md`；review artifacts `docs/reviews/wu-tools-01-f03-plan-review-mimo.md`, `docs/reviews/wu-tools-01-f03-plan-review-ds.md`, `docs/reviews/wu-tools-01-f03-plan-review-controller-adjudication.md`, `docs/reviews/wu-tools-01-f03-plan-rereview-mimo.md`, `docs/reviews/wu-tools-01-f03-plan-rereview-ds.md`；accepted plan commit `262a6021`。Implementation must generate explicit opt-in Web smoke from the migrated web CI diagnostics pipeline, including local PDF Docling invocation evidence, and close or transfer residual `WU-TOOLS-01-S5-R2` with owner. |
