...
| gate | implementation |
| implementation status | WU-CM-01-F02 Slice 5 implementation-ready |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-CM-01-F02 |
| next entry point | AgentCodex implements Slice 5 compact evidence query readability |
...
| WU-CM-01-F02 | implementation-slice-5 | Compact evidence query readability quality closeout | GitHub Issue #81 / WU-CM-01 final closeout；depends on WU-DUR-P01 durable tool-call atoms | Slice 5 implementation entry point: compact evidence query_text must consume durable tool-call arguments / semantic query atom or emit structured limited-signal |
