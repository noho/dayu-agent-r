...
| implementation status | WU-OBS-SIGNALS-01 OBS-SIG-04 code review passed and accepting slice |
| active work unit | WU-OBS-SIGNALS-01 |
| default next work unit | WU-OBS-SIGNALS-01 |
| next entry point | WU-OBS-SIGNALS-01 OBS-SIG-04 accepted slice commit |
