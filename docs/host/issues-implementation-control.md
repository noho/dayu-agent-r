...
| gate | accepting-slice |
| implementation status | WU-OBS-SIGNALS-01 OBS-SIG-05 integration validation passed and accepting gate |
| active work unit | WU-OBS-SIGNALS-01 |
| default next work unit | WU-OBS-SIGNALS-01 |
| next entry point | WU-OBS-SIGNALS-01 OBS-SIG-05 accepted integration commit |
