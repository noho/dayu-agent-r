...
| gate | implementation-accepted |
| implementation status | WU-CM-01-F01-S7-R1 S7-R1-S1 production implementation accepted; ready for final Slice 7 public-path validation |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-CM-01-F01 |
| next entry point | run final Slice 7 public-path validation after S7-R1-S1 acceptance |
...
| WU-CM-01-F01-S7-R1 | WU-CM-01-F01 Slice 7 retry blocker | public runner-call multi-system-message shape | open | WU-CM-01-F01 production RunInput / memory projection rescope | Implement S7-R1-S1 production one-system-message assembly and focused tests. | S0 design sync and fix are accepted; S7-R1-S1 implementation review must confirm §24.6 assembly order maps to the §23 system envelope table. |
...
| WU-CM-01-F01 | implementation-S7-R1-S1-production | Conversation Memory smoke correctness closeout | GitHub Issue #81 / WU-CM-01 final closeout | S7-R1 S0 design accepted; production `run_input.py` one-system-message implementation is next |
