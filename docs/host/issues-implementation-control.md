...
| next entry point | Await user manual validation feedback for prompt / interactive behavior, then enter final closeout for this context slot follow-up if no new blocker is found. |
