...
| gate | implementation |
| implementation status | WU-CM-01-F01-S7-R1 S7-R1-S0 design accepted; S7-R1-S1 production implementation ready |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-CM-01-F01 |
| next entry point | implement S7-R1-S1 production one-system-message assembly in `dayu/host/run_input.py` |
