...
| next entry point | WU-LIFE-03 / draft PR #167 review gate. |
...
| WU-LIFE-03 | draft-PR-pass | Active cancel watchdog | GitHub Issue #91 / #87 umbrella | Draft PR #167 已创建并保持 draft；当前进入 PR review gate。固定 Host-level active cancel watchdog、post-cancel timeout closeout、late terminal race 和 diagnostic 语义。只负责 Host truth / timeout closeout，不负责 tool/provider hard interrupt。 |
