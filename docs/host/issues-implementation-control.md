...
| gate | review |
| implementation status | WU-DUR-P01 Slice 2 fix-ready-for-re-review |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-DUR-P01 |
| next entry point | AgentMiMo and AgentDS re-review Slice 2 accepted fixes |
...
| WU-DUR-P01 | review-slice-2 | EventLog runner-call reconstruction atoms | GitHub Issue #117 | Slice 2 fix completed and awaits re-review |
