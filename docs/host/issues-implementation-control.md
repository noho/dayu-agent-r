...
| gate | draft-PR-pass |
| implementation status | WU-TOOLS-01-F01-03 PR #131 merged 2026-06-09; WU-TOOLS-01-F02 draft PR #132 passed local gate workflow; waiting user merge decision |
...
| WU-TOOLS-01-F01-03 | draft-PR-pass | Production Fins CN/SEC download and upload runtime/tool migration | WU-TOOLS-01-F01 draft PR preflight follow-up; absorbs WU-TOOLS-01-F09 | Goal confirmation accepted in `docs/reviews/wu-tools-01-f01-03-goal-confirmation-controller.md`；plan artifact 为 `docs/host/wu-tools-01-f01-03-production-fins-ingestion-plan.md`；plan review artifacts 为 `docs/reviews/wu-tools-01-f01-03-plan-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-plan-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-plan-review-controller-adjudication.md`；plan fix artifact 为 `docs/reviews/wu-tools-01-f01-03-plan-fix-codex.md`；plan re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-plan-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-plan-rereview-ds.md`；re-review controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-plan-rereview-controller-adjudication.md`；accepted plan commit 为 `6f519cea`。Slice 1 implementation 已完成，artifact 为 `docs/reviews/wu-tools-01-f01-03-slice1-implementation-codex.md`；Controller 复验 `pytest tests/fins/test_fins_ingestion_runtime.py -q` 结果为 35 passed，pyright 0 errors，`git diff --check` 通过。Slice 1 code review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice1-code-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice1-code-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice1-code-review-controller-adjudication.md`；两路均为 `pass-with-findings` 且 0 blocking findings，Controller 接受 4 项 low-severity fix。Slice 1 fix artifact 为 `docs/reviews/wu-tools-01-f01-03-slice1-fix-codex.md`；Controller 复验 `pytest tests/fins/test_fins_ingestion_runtime.py -q` 结果为 36 passed，pyright 0 errors，`git diff --check` 通过。Slice 1 re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice1-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice1-rereview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice1-rereview-controller-adjudication.md`；两路确认 4/4 accepted findings fixed，Controller 追加接受 `_save_failed` stale-record terminalization 同源竞态 follow-up。Slice 1 follow-up fix artifact 为 `docs/reviews/wu-tools-01-f01-03-slice1-fix-followup-codex.md`；Controller 复验 `pytest tests/fins/test_fins_ingestion_runtime.py -q` 结果为 37 passed，pyright 0 errors，`git diff --check` 通过。Slice 1 follow-up re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice1-followup-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice1-followup-rereview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice1-followup-rereview-controller-adjudication.md`；两路确认 CTRL-RR1 fixed，0 blocking findings。Slice 1 accepted commit 为 `8f11fac9`。Slice 2 SEC downloader and SEC download runtime implementation 已完成，artifact 为 `docs/reviews/wu-tools-01-f01-03-slice2-implementation-codex.md`；Controller 复验 `pytest tests/fins/test_sec_downloader.py tests/fins/test_sec_pipeline_download.py tests/fins/test_sec_pipeline_download_stream.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 111 passed、7 warnings，pyright 0 errors，`git diff --check` 通过；Slice 2 type-signature scan 未发现 `Any` / type `object`，boundary scan 未发现 CN/HK、upload/process 或 Host/Engine 反向依赖。Slice 2 code review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice2-code-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice2-code-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice2-code-review-controller-adjudication.md`；Controller 裁决 `fix-required`，接受 SEC `rejected_count` 统计、测试 docstring、dead method、stray marker、unused helper、pipelines package docstring 与 `persisted_summary`/`rebuild_processed` 责任边界说明，驳回把 NEW `rebuild_processed` 直接映射到 OLD `SecPipeline.download(rebuild=...)` 的修法。Slice 2 fix artifact 为 `docs/reviews/wu-tools-01-f01-03-slice2-fix-codex.md`；Controller 复验 `pytest tests/fins/test_sec_downloader.py tests/fins/test_sec_pipeline_download.py tests/fins/test_sec_pipeline_download_stream.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 113 passed、3 warnings，pyright 0 errors，`git diff --check` 通过，targeted type scan 无匹配。Slice 2 re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice2-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice2-rereview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice2-rereview-controller-adjudication.md`；两路确认 7/7 accepted findings fixed，0 blocking findings，0 new findings。Slice 2 accepted commit 为 `0a2ec16c`。Slice 3 CN/HK downloader and CN/HK download runtime implementation 已完成，artifact 为 `docs/reviews/wu-tools-01-f01-03-slice3-implementation-codex.md`；Controller 复验 `pytest tests/fins/test_cninfo_downloader.py tests/fins/test_hkexnews_downloader.py tests/fins/test_cn_download_workflow.py tests/fins/test_cn_download_runtime.py tests/fins/test_cn_pipeline.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 111 passed、3 warnings，pyright 0 errors，`git diff --check` 通过；Slice 3 type-signature scan 未发现 `Any` / type `object`，boundary scan 未发现 upload/process/CLI 或 Host/Engine 反向依赖。Slice 3 code review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice3-code-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice3-code-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice3-code-review-controller-adjudication.md`；Controller 裁决 `fix-required`，接受 CN/HK factory defaults split、unused `ProcessorRegistry` removal、CNInfo lazy import cleanup、`CnDownloadCancelledError` shared location、Chinese docstrings 和 absolute import 六项 fix。Slice 3 fix artifact 为 `docs/reviews/wu-tools-01-f01-03-slice3-fix-codex.md`；Controller 复验 `pytest tests/fins/test_cninfo_downloader.py tests/fins/test_hkexnews_downloader.py tests/fins/test_cn_download_workflow.py tests/fins/test_cn_download_runtime.py tests/fins/test_cn_pipeline.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 112 passed、3 warnings，pyright 0 errors，`git diff --check` 通过；type scan 与 boundary scan 无匹配。Slice 3 re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice3-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice3-rereview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice3-rereview-controller-adjudication.md`；两路确认 6/6 accepted findings fixed，0 blocking findings，0 new findings。Slice 3 accepted commit 为 `97442f6a`。Slice 4 production upload runtime implementation 已完成，artifact 为 `docs/reviews/wu-tools-01-f01-03-slice4-implementation-codex.md`；Controller 复验 `pytest tests/fins/test_docling_upload_service.py tests/fins/test_docling_upload_service_integration.py tests/fins/test_sec_pipeline_upload_filing_stream.py tests/fins/test_sec_pipeline_upload_material_stream.py tests/fins/test_cn_pipeline.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 58 passed、1 skipped、3 warnings，pyright 0 errors，`git diff --check` 通过；type scan 与 boundary scan 无匹配。Slice 4 code review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice4-code-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice4-code-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice4-code-review-controller-adjudication.md`；Controller 裁决 `fix-required`，接受 stale docstrings、`docling_upload_service.__all__` private helper exports、dead `cast_upload_host`、DefaultFinsRuntime pipeline instance split 注释四项 fix。Slice 4 fix artifact 为 `docs/reviews/wu-tools-01-f01-03-slice4-fix-codex.md`；Controller 复验 `pytest tests/fins/test_docling_upload_service.py tests/fins/test_docling_upload_service_integration.py tests/fins/test_sec_pipeline_upload_filing_stream.py tests/fins/test_sec_pipeline_upload_material_stream.py tests/fins/test_cn_pipeline.py tests/fins/test_fins_ingestion_runtime.py -q` 结果为 58 passed、1 skipped、3 warnings，pyright 0 errors，`git diff --check` 通过；type scan、boundary scan、`__all__` private export scan 与 dead helper scan 无匹配。Slice 4 re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice4-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice4-rereview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice4-rereview-controller-adjudication.md`；两路确认 4/4 accepted findings fixed，0 blocking findings，0 new findings。Slice 4 accepted commit 为 `bb74fa1d`。Slice 5 upload awaiting tool/provider/wait adapter/service assembly implementation 已完成，artifact 为 `docs/reviews/wu-tools-01-f01-03-slice5-implementation-codex.md`；Controller 补充 empty upload file must fail before durable job creation 的实现与测试；Controller 复验 `pytest tests/fins/test_fins_ingestion_tools.py tests/service/test_host_assembly.py tests/tools/test_combined_tools_acceptance.py -q` 结果为 73 passed、3 warnings，pyright 0 errors，`git diff --check` 通过；type scan、boundary scan 与 upload schema internal-governance scan 无匹配。Slice 5 code review artifacts 为 `docs/reviews/wu-tools-01-f01-03-slice5-code-review-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-slice5-code-review-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-slice5-code-review-controller-adjudication.md`；MiMo verdict `pass`，DS verdict `pass-with-findings`，Controller 驳回 DS F1 恢复 download awaiting test terminal wait 的建议，证据为 production download 长事务在工具 start-boundary 测试中 5s 内不保证终态，终态生命周期由 runtime/pipeline tests 覆盖；Slice 5 accepted commit 为 `2504df4c`。Slice 6 closeout artifact 为 `docs/reviews/wu-tools-01-f01-03-slice6-closeout-controller.md`；Issue #129 comment `https://github.com/noho/dayu-agent-r/issues/129#issuecomment-4659131069` 已记录 `start_upload` 纳入 prepare/activate tracking；Controller full validation `pytest tests/fins tests/service/test_host_assembly.py tests/tools/test_combined_tools_acceptance.py -q` 结果为 294 passed、1 skipped、3 warnings，`python -m pyright dayu/ tests/ utils/` 结果为 0 errors。Aggregate deepreview artifacts 为 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-ds.md`；controller adjudication 为 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-controller-adjudication.md`；MiMo verdict `pass-with-findings`，DS verdict `pass`，Controller 接受 MiMo F1/F2 LLM-facing 错误文案内部术语修复。Aggregate deepreview fix artifact 为 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-fix-codex.md`；re-review artifacts 为 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-rereview-mimo.md` 与 `docs/reviews/wu-tools-01-f01-03-aggregate-deepreview-rereview-ds.md`；两路确认 F1/F2 fixed，0 new findings；accepted deepreview commit 为 `1b14444c`。Draft PR #131 已创建：`https://github.com/noho/dayu-agent-r/pull/131`。PR review accepted commit 为 `8f016ac3`，final closeout artifact 为 `docs/reviews/wu-tools-01-f01-03-final-closeout-controller.md`。当前进入 draft-PR-pass，等待用户 merge decision。迁移 / 建立 CN download、SEC download、CN upload、SEC upload 的真实可用 runtime 与 tool 入口；本 WU 是 OLD 实现迁移与 NEW contract adaptation，不是业务逻辑重写；OLD SEC/CN/HK downloader 与 SEC/CN pipeline download/upload workflow 实现代码不能重写，接口可为 NEW 分层和契约适配。Upload 已裁决为长事务；`start_upload` 已进入 awaiting external job 路径，Issue #129 已追踪 prepare / activate 后续。Tool 当前可访问，未来 CLI / CI 只能通过同一 shared Fins service/runtime 访问，不得再造 CLI / tool / CI 三套逻辑。 |
| WU-TOOLS-01-F02 | draft-PR-pass | Web CI diagnostics pipeline migration | GitHub Issue #120 under #98 follow-up; draft PR #132 https://github.com/noho/dayu-agent-r/pull/132 | Plan accepted in commit `ded9e690`; Slice 1 accepted commit `8f5bb379`; Slice 2 accepted commit `6984c514`; Slice 3 accepted commit `89604aa0`; accepted deepreview commit `0f843b34`; readiness commit `05f1229e`; accepted PR review commit `a625833b`; final closeout artifact `docs/reviews/wu-tools-01-f02-final-closeout-controller.md`; draft PR #132 created and passed local PR review gate; plan artifact `docs/host/wu-tools-01-f02-web-ci-diagnostics-plan.md`. Slice 2 migrated current-contract `utils/diagnose_web_access.py`; implementation artifact `docs/reviews/wu-tools-01-f02-slice2-implementation-codex.md`; code review artifacts `docs/reviews/wu-tools-01-f02-slice2-code-review-mimo.md` and `docs/reviews/wu-tools-01-f02-slice2-code-review-ds.md`; Controller adjudication `docs/reviews/wu-tools-01-f02-slice2-code-review-controller-adjudication.md`; fix artifact `docs/reviews/wu-tools-01-f02-slice2-fix-codex.md`; re-review artifacts `docs/reviews/wu-tools-01-f02-slice2-rereview-mimo.md` and `docs/reviews/wu-tools-01-f02-slice2-rereview-ds.md`; re-review Controller adjudication `docs/reviews/wu-tools-01-f02-slice2-rereview-controller-adjudication.md`. Controller validation before Slice 2 accept: `python -m py_compile utils/diagnose_web_access.py` passed, `python -m pyright dayu/ tests/ utils/` passed with 0 errors, `bash -n utils/diag_web.sh utils/diag_web_batch.sh` passed, forbidden OLD dependency / wide-type scan had no matches, and `git diff --check` passed. Slice 3 added deterministic diagnostics tests in `tests/tools/web/test_diagnose_web_access.py`, kept `tests/README.md` unchanged by documented boundary, and added diagnostics-only failed outcome fields in `utils/diagnose_web_access.py`; implementation artifact `docs/reviews/wu-tools-01-f02-slice3-implementation-codex.md`; code review artifacts `docs/reviews/wu-tools-01-f02-slice3-code-review-mimo.md` and `docs/reviews/wu-tools-01-f02-slice3-code-review-ds.md`; Controller adjudication `docs/reviews/wu-tools-01-f02-slice3-code-review-controller-adjudication.md`; fix artifact `docs/reviews/wu-tools-01-f02-slice3-fix-codex.md`; re-review artifacts `docs/reviews/wu-tools-01-f02-slice3-rereview-mimo.md` and `docs/reviews/wu-tools-01-f02-slice3-rereview-ds.md`; re-review Controller adjudication `docs/reviews/wu-tools-01-f02-slice3-rereview-controller-adjudication.md`. Controller validation before Slice 3 accept: `pytest tests/tools/web/test_diagnose_web_access.py tests/tools/web/test_web_tools_provider.py -q` passed with 23 tests, `python -m pyright dayu/ tests/ utils/` passed with 0 errors, `bash -n utils/diag_web.sh utils/diag_web_batch.sh` passed, precise forbidden import / wide-type scan had no matches, and `git diff --check` passed. Aggregate deepreview artifacts are `docs/reviews/wu-tools-01-f02-aggregate-deepreview-mimo.md` and `docs/reviews/wu-tools-01-f02-aggregate-deepreview-ds.md`; Controller adjudication is `docs/reviews/wu-tools-01-f02-aggregate-deepreview-controller-adjudication.md`; aggregate fix artifact is `docs/reviews/wu-tools-01-f02-aggregate-deepreview-fix-codex.md`; aggregate re-review artifacts are `docs/reviews/wu-tools-01-f02-aggregate-deepreview-rereview-mimo.md` and `docs/reviews/wu-tools-01-f02-aggregate-deepreview-rereview-ds.md`; aggregate re-review Controller adjudication is `docs/reviews/wu-tools-01-f02-aggregate-deepreview-rereview-controller-adjudication.md`; PR review artifacts are `docs/reviews/wu-tools-01-f02-pr-review-mimo.md` and `docs/reviews/wu-tools-01-f02-pr-review-ds.md`; PR review Controller adjudication is `docs/reviews/wu-tools-01-f02-pr-review-controller-adjudication.md`. Controller validation before final closeout: `pytest tests/tools/web/test_diagnose_web_access.py tests/tools/web/test_web_tools_provider.py -q` passed with 27 tests, `python -m pyright dayu/ tests/ utils/` passed with 0 errors, `bash -n utils/diag_web.sh utils/diag_web_batch.sh` passed, precise forbidden import / wide-type scan had no matches, and `git diff --check` passed. First step of Web CI diagnostics pipeline migrates OLD `web_ci_urls.jsonl`, `diag_web.sh`, `diag_web_batch.sh` and `utils/diagnose_web_access.py`; does not close `WU-TOOLS-01-S5-R2` by itself |
...
Draft-PR-pass。该 work unit 是 `WU-TOOLS-01-F01` draft PR 前置 follow-up，并吸收原 `WU-TOOLS-01-F09`。Goal confirmation artifact 为 `docs/reviews/wu-tools-01-f01-03-goal-confirmation-controller.md`。当前裁决：Fins 不能只停留在抽象 download / upload contract；CN download、SEC download、CN upload、SEC upload 必须从 OLD 迁移代码并进入真实可用状态。Tool 侧当前可访问，未来 CLI / CI 也必须通过同一 shared Fins service/runtime 访问，避免 CLI / tool / CI 三套逻辑漂移。本 WU 是 OLD 可靠实现迁移与 NEW contract adaptation，不是业务逻辑重写；OLD SEC/CN/HK downloader 与 SEC/CN pipeline download/upload workflow 实现代码不能重写，接口可为 NEW 分层和契约适配。Upload 已由用户裁决为长事务，`start_upload` 已按 awaiting / durable ingestion job 方向接入 tool/provider/wait adapter/service assembly。Aggregate deepreview 已完成并提交，draft PR #131 已创建，PR review 已完成并提交，当前等待用户 merge decision。
