...
| gate | planning |
| implementation status | WU-CM-01-F02-S6-R1 production compact instruction contract rescope-ready |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-CM-01-F02 |
| next entry point | AgentCodex drafts production compact instruction contract rescope plan for `WU-CM-01-F02-S6-R1` before retrying Slice 7 |
...
| WU-CM-01-F02 | rescope-planning | Compact evidence query readability quality closeout | GitHub Issue #81 / WU-CM-01 final closeout；depends on WU-DUR-P01 durable tool-call atoms | Next entry point: plan production compact instruction contract rescope for `WU-CM-01-F02-S6-R1`, then retry WU-CM-01-F01 Slice 7 |
