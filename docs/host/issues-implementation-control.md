...
| blocking open questions | No blocking open question for Round3 R3-A dispatch. The umbrella WU remains open until accepted Round3 sub WUs R3-A through R3-E are implemented, reviewed, fixed, validated, committed, and final closeout passes; R3-F has passed local final closeout. |
