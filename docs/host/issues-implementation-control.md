...
| blocking open questions | No blocking open question for Round3 R3-B aggregate validation / deepreview entry. The umbrella WU remains open until accepted Round3 sub WUs R3-B through R3-E are implemented, reviewed, fixed, validated, committed, and final closeout passes; R3-F and R3-A have passed local final closeout. |
