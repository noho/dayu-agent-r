...
| next entry point | WU-LIFE-03 / PR #167 accepted PR review commit and final closeout gate. |
...
| WU-LIFE-03 | draft-PR-pass | Active cancel watchdog | GitHub Issue #91 / #87 umbrella | Draft PR #167 双路 PR review 已通过，无当前修复；等待 accepted PR review commit 和 final closeout。固定 Host-level active cancel watchdog、post-cancel timeout closeout、late terminal race 和 diagnostic 语义。只负责 Host truth / timeout closeout，不负责 tool/provider hard interrupt。 |
