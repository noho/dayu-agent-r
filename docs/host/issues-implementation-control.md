...
| gate | implementation |
| implementation status | WU-TOOLS-01-F02 PR #132 merged 2026-06-10; WU-TOOLS-01-F03 Slice 3 accepted, accepted slice commit ea2cef7c |
| active work unit | WU-TOOLS-01-F03 |
| default next work unit | WU-TOOLS-01-F03 |
| next entry point | WU-TOOLS-01-F03 implementation gate, Slice 4 optional external diagnostics without gate semantics |
