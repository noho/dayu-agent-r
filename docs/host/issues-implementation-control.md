...
| gate | planning |
| implementation status | slice-c-implementation-blocked-engine-ingest-context-governance |
| active work unit | WU-CM-01 |
| default next work unit | WU-CM-01 |
| next entry point | WU-CM-01 Slice C plan boundary follow-up gate |
