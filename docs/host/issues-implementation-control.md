...
| implementation status | WU-TOOLS-01 plan re-review passed; accepted plan commit pending |
| active work unit | WU-TOOLS-01 |
| default next work unit | WU-TOOLS-01 |
| next entry point | WU-TOOLS-01 accepted plan commit gate; commit plan, review, fix, re-review, controller adjudication and control-doc artifacts |
...
| WU-TOOLS-01 | planning | Fins / Web / Doc tools migration with shared document foundations | GitHub Issue #82 / #97 / #98 | Plan artifact `docs/host/wu-tools-01-migration-plan.md` accepted after AgentMiMo / AgentDS plan re-review PASS；单一 work unit，先迁移 shared document foundations，再按 Doc tools、Fins、Web tools slice 实施，且必须严格遵守迁移原则 |
