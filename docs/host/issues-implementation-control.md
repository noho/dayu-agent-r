...
| next entry point | Create accepted plan commit for the context slot / FMP / scene tool filtering follow-up, then enter implementation Slice S1 from `docs/host/wu-cli-smoke-01-context-slot-fmp-scene-filter-plan.md`. |
