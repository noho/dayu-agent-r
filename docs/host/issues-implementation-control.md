...
| implementation status | WU-TOOLS-01-F01-02-R3 aggregate deepreview accepted after MiMo / DS re-review; accepted deepreview commit `865b15e4`; 115-test focused suite, pyright, diff check, legacy rg and F04-F07 control-doc rg passed; all R3 residual risks have owner or are closed |
| active work unit | WU-TOOLS-01-F01-02-R3 |
| default next work unit | WU-TOOLS-01-F08 |
| next entry point | WU-TOOLS-01-F01-02-R3 ready-to-open-draft-PR gate |
...
| WU-TOOLS-01-F01-02-R3 | ready-to-open-draft-PR | Retire legacy tool adapter and fix cancellation outcome projection | GitHub Issue #130 | Active work unit；accepted plan commit `7b465e19`；Slice 0 / 1 / 2 / 3 / 4 accepted commits `a5ab5364` / `1bbc45fe` / `ac0c7303` / `2a914234` / `a24f6dc9`；accepted deepreview commit `865b15e4`；R3 active residual closed by adapter deletion, native Doc/Web/Fins read providers, cancellation outcome fix, aggregate re-review PASS, and Controller validation；next gate is draft PR readiness |
