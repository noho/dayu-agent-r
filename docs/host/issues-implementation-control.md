...
| next entry point | WU-LIFE-03 / GitHub Issue #91 aggregate deepreview for the completed WU-LIFE-03 local changes after accepted Slice 2 commit `3ff42b15`. |
...
| WU-LIFE-03 | review | Active cancel watchdog | GitHub Issue #91 / #87 umbrella | Accepted Slice 2 commit `3ff42b15` 已创建；当前进入 aggregate deepreview。固定 Host-level active cancel watchdog、post-cancel timeout closeout、late terminal race 和 diagnostic 语义。只负责 Host truth / timeout closeout，不负责 tool/provider hard interrupt。 |
