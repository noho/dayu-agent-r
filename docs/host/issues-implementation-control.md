...
| gate | review |
| implementation status | WU-CM-09 aggregate deepreview PASS；ready for accepted deepreview commit |
| active work unit | WU-CM-09 |
| default next work unit | WU-OBS-00 |
| next entry point | WU-CM-09 accepted deepreview commit；after commit enter WU-OBS-00 discussion gate |
...
| WU-CM-09 | review | Durable memory snapshot corruption policy | GitHub Issue #41 | #81 已关闭；aggregate deepreview PASS；accepted deepreview commit pending |
...
- accepted deepreview commit: pending
