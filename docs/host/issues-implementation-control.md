...
| implementation status | aggregate-deepreview-ready |
| active work unit | WU-ENG-02 |
| default next work unit | WU-CM-01 |
| next entry point | aggregate deepreview gate |
