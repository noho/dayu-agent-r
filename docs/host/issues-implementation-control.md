...
| next entry point | Dispatch implementation Slice S1 to AgentCodex using `docs/host/wu-cli-smoke-01-dayu-cli-core-usability-plan.md`. |
...
| blocking open questions | None for implementation. Manual real-environment prompt / interactive / optional Fins direct evidence remains required later in this WU, but does not block Slice S1 implementation. |
