...
| implementation status | WU-CM-06-S2 review passed；ready for accepted slice commit |
| active work unit | WU-CM-06 |
| default next work unit | WU-OBS-00 |
| next entry point | WU-CM-06-S2 accepted slice commit；after commit enter WU-CM-06 aggregate deepreview gate |
