...
| gate | planning |
| implementation status | slice-c-plan-fix |
| active work unit | WU-CM-01 |
| default next work unit | WU-CM-01 |
| next entry point | WU-CM-01 Slice C plan fix/reslice gate |
