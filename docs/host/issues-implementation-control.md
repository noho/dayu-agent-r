...
| PR-135-R1 | deferred-with-owner | Repository CI configuration / future CI workflow owner | PR #135 currently reports no GitHub checks; validation is local gate evidence. Not a code blocker for R3 or F08, but future CI configuration should provide PR-page auditability. |
