...
| blocking open questions | No blocking open question for implementation. Upload tool exposure remains deferred to separate user裁决; real FMP / LLM smoke depends on credentials and network and is optional environment-supported validation, not CI gating. |
