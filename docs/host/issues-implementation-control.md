...
| gate | implementation |
| implementation status | slice-b-implementation |
| active work unit | WU-CM-01 |
| default next work unit | WU-CM-01 |
| next entry point | WU-CM-01 Slice B implementation gate |
