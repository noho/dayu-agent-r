...
| next entry point | WU-LIFE-03 / GitHub Issue #91 implementation: implement Slice 2 Host active cancel watchdog runtime integration, startup/recovery ordering, promotion, and public watch behavior. |
