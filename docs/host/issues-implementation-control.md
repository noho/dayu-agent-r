...
| implementation status | slice-3-accepted-pending-commit |
| active work unit | WU-ENG-02 |
| default next work unit | WU-CM-01 |
| next entry point | Slice 3 accepted slice commit |
