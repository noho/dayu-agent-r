...
| gate | planning |
| implementation status | WU-CM-06 aggregate deepreview passed；ready for accepted deepreview commit；WU-CM-08 preflight next |
| active work unit | WU-CM-08 |
| default next work unit | WU-OBS-00 |
| next entry point | WU-CM-08 planning preflight gate |
...
| WU-CM-06 | completed | Terminal summary text policy convergence | GitHub Issue #94 / #81 child | #81 已关闭；aggregate deepreview passed；accepted deepreview commit pending |
| WU-CM-08 | planning | Compaction material readability and smoke maintenance | GitHub Issue #95 / #81 child | #81 已关闭；用户指定恢复推进 |
