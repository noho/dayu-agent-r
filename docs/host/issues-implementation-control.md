...
| gate | implementation |
| implementation status | WU-TOOLS-01-F01 Slice S4 accepted commit `2727b900`; Slice S5 implementation pending |
| active work unit | WU-TOOLS-01-F01 |
| default next work unit | WU-TOOLS-01-F01 |
| next entry point | Implement WU-TOOLS-01-F01 Slice S5 Fins wait adapter and Service assembly wiring |
