...
| implementation status | WU-CM-08-S2 code review passed；ready for accepted slice commit |
| active work unit | WU-CM-08 |
| default next work unit | WU-OBS-00 |
| next entry point | WU-CM-08-S2 accepted slice commit；after commit enter WU-CM-08 aggregate deepreview |
