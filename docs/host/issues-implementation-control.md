...
| next entry point | Wait for user / maintainer to handle draft PR #169. After PR #169 merges, pull updated `main` and start WU-TOOLS-CANCEL-01. After both WU-LIFE-04 and WU-TOOLS-CANCEL-01 are complete, Issue #87 can be closed as the lifecycle watchdog / supervisor umbrella. |
