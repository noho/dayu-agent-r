...
| WU-TOOLS-01-F08-R1 | deferred-with-owner | Repository CI configuration / future CI workflow owner | PR #135 currently reports no GitHub checks; validation is local gate evidence. Not a code blocker for F08, but future CI configuration should provide PR-page auditability. |
...
| WU-TOOLS-01-F01-02-R3 | draft-PR-pass-final-closeout-passed | Retire legacy tool adapter and fix cancellation outcome projection | GitHub Issue #130；draft PR https://github.com/noho/dayu-agent-r/pull/135 | Final closeout passed；artifact `docs/reviews/wu-tools-01-f01-02-r3-final-closeout-controller.md`；accepted plan commit `7b465e19`；Slice 0 / 1 / 2 / 3 / 4 accepted commits `a5ab5364` / `1bbc45fe` / `ac0c7303` / `2a914234` / `a24f6dc9`；accepted deepreview commit `865b15e4`；accepted PR review commit `ba33cbf0` pushed；R3 active residual closed；waiting for user merge decision；default next work unit is WU-TOOLS-01-F08 |
...
| WU-TOOLS-01-F08 | draft-PR-pass-final-closeout-passed | Documents processor registry naming cleanup | WU-TOOLS-01 post-migration cleanup；draft PR #135 | Final closeout passed; PR #135 updated and remains draft/open waiting for user merge decision. Accepted plan commit `a0c00567`; accepted implementation commit `f669942e`; accepted deepreview commit `12812074`; accepted plan artifact `docs/host/wu-tools-01-f08-documents-processor-registry-naming-plan.md`; implementation artifact `docs/reviews/wu-tools-01-f08-implementation-codex.md`; code review artifacts `docs/reviews/wu-tools-01-f08-code-review-mimo.md`, `docs/reviews/wu-tools-01-f08-code-review-ds.md`, `docs/reviews/wu-tools-01-f08-code-review-controller-adjudication.md`; aggregate deepreview artifacts `docs/reviews/wu-tools-01-f08-aggregate-deepreview-mimo.md`, `docs/reviews/wu-tools-01-f08-aggregate-deepreview-ds.md`, `docs/reviews/wu-tools-01-f08-aggregate-deepreview-controller-adjudication.md`; PR review artifacts `docs/reviews/wu-tools-01-f08-pr-review-mimo.md`, `docs/reviews/wu-tools-01-f08-pr-review-ds.md`, `docs/reviews/wu-tools-01-f08-pr-review-controller-adjudication.md`; final closeout artifact `docs/reviews/wu-tools-01-f08-final-closeout-controller.md`. Renamed documents registry builder to `build_documents_processor_registry(...)`, updated direct callers / exports / docs, and kept processor registration behavior unchanged. Residual `WU-TOOLS-01-S1-R2` closed by implementation evidence; PR checks residual `WU-TOOLS-01-F08-R1` deferred with owner. |
