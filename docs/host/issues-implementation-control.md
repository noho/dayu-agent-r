...
| implementation status | WU-OBS-P00 Slice 4 accepted-ready-for-commit |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-OBS-P00 |
| next entry point | create accepted Slice 4 commit after final validation |
...
| WU-OBS-P00 | accepted-slice-4-ready-for-commit | Runner call input reconstruction signals | GitHub Issue #70 / #117 | Slice 4 code review passed and awaits accepted commit |
