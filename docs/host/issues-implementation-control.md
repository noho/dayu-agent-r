...
| gate | review |
| implementation status | WU-DUR-P01 Slice 1 fix-ready-for-re-review |
| active work unit | WU-DUR-P01 / WU-OBS-P00 / WU-CM-01-F02 / WU-CM-01-F01 |
| default next work unit | WU-DUR-P01 |
| next entry point | AgentMiMo and AgentDS re-review Slice 1 accepted fixes |
...
| WU-DUR-P01 | review-slice-1 | EventLog runner-call reconstruction atoms | GitHub Issue #117 | Slice 0 design contract writeback 已通过 design review 并提交为 83cf38d8；当前进入 Slice 1 durable tool-call request atoms re-review |
