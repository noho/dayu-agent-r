...
| blocking open questions | No blocking open question for Round3 R3-C aggregate validation / deepreview entry. The umbrella WU remains open until accepted Round3 sub WUs R3-C through R3-E are implemented, reviewed, fixed, validated, committed, and final closeout passes; R3-F, R3-A, R3-B, and R3-C S1 through S3 have passed local slice acceptance. |
